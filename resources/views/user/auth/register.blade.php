                    ...
                    <div class="row w-100 mx-0">
                        <div class="col-lg-4 mx-auto">
                            <div class="auth-form-light text-start py-5 px-4 px-sm-5">
                                <h4 class="fw-light">Create an account</h4>
                                <form class="pt-3" method="post" action="{{route('user.auth.register')}}">
                                    @csrf
                                    ...
                                    <div class="text-center mt-4 fw-light">
                                        have an account? <a href="{{route('user.login')}}" class="text-primary">Login</a>
                                    </div>
                                </form>
                            </div>
                        </div>
